...
byte MAC[6] = { 0x8C, 0x4C, 0xAD, 0xF0, 0xBF, 0x2F };
...
String devNamePrefix = "WTS4Channel";
String alertTopic = "WTSAlert4Channel";
String subTopic = "/control";  // devName + 6 digits of MAC + /Control
String pubTopic = "/status";   // // devName + 6 digits of MAC + /Status
String globalTopic = "WTS4ChannelGlobal";
String apSSID = "WTS4ChannelAp";
...
const byte maxThresholdTempForAlertEEPROMAdd = 46;
